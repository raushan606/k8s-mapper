...
export const MainContent: React.FC<MainContentProps> = ({ namespace, children, initialData }) => {
    return (
        <Box sx={{ width: '100%', height: '100%' }}>
            ...
            <Paper elevation={0} sx={{ p: 2, mb: 3, borderRadius: 3, border: '1px solid #E5E7EB', minHeight: 420, position: 'relative' }}>
                {/* Place your TopologyGraph here */}
                <Box sx={{ width: '100%', height: 380 }}>
                    <TopologyGraph initialData={initialData} namespace={namespace} />
                </Box>
                {/* Legend can go here if needed */}
                {/* <Legend /> */}
            </Paper>
